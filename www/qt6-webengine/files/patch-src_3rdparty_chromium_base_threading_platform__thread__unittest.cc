--- src/3rdparty/chromium/base/threading/platform_thread_unittest.cc.orig	2022-09-26 10:05:50 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #include <sys/types.h>
@@ -319,7 +319,7 @@ TEST(PlatformThreadTest, CanChangeThreadPriority) {
...
@@ -417,7 +417,7 @@ TEST(PlatformThreadTest, GetDefaultThreadStackSize) {
